    ...
    if (isLoading) {
      ...
      progressInterval = setInterval(() => {
        setProgress((prevProgress) => {
          if (prevProgress < 40) return prevProgress + 10;
          else if (prevProgress < 70) return prevProgress + 5;
          else if (prevProgress < 90) return prevProgress + 2;
          else if (prevProgress < 98) return prevProgress + 0.5;
          else {
        ...
        >
          <div className="flex flex-col items-center w-full max-w-2xl px-4">
            <div className="relative w-full h-64 md:h-80">
              ...
              <motion.svg 
                viewBox="200 -300 800 800" // Adjusted viewBox to better fit the logo
                className="absolute inset-0 h-full w-full"
